...
import { TOP_DIFFICULTY_DOC_LIMIT } from "../../../shared/aso-difficulty-policy";
...
export const DIFFICULTY_DETAIL_LIMIT = TOP_DIFFICULTY_DOC_LIMIT;
export const DIFFICULTY_AVG_WEIGHT = 2;
export const DIFFICULTY_MIN_WEIGHT = 4;
...
export function calculateAppDifficultyBreakdown(
  ...
  const score = Math.max(
    ...
    (RATING_COUNT_WEIGHT * normalizedRatingCount +
      AVG_RATING_WEIGHT * normalizedAvgRatingValue +
      AGE_WEIGHT * normalizedAge +
      KEYWORD_MATCH_WEIGHT * keywordScore +
